...
def IGH_FR2(folder_name, loc, loc_save, region, patient_id, region_graph, dic, svr, svc, sjr, sjc, srr, src,
    ...
    def IGH_FR2_table(data, col_width=10.0, row_height=0.625, font_size=14,
        ...
        fig.savefig("./plots/" + patient_id[0:3] + "_LymphoVisual/" + patient_id + "_IGH_FR2_table.png")
        return ax

    IGH_FR2_table(df, header_columns=0, col_width=5.0)
