...
set output 'IGH_FR2_VJ_Sequence_Frequencies.png'
set title font "Helvetica,30" 
set title 'LymphoVisual IGH FR2 Assay - V - J Sequence Frequencies : Top 200 Sequences'
set grid y
...
plot 'IGH_FR2_VJ_Sequence_Frequencies.tsv' using 2 ti col, \
	'' using 3 ti col , \
	'' using 4 ti col , \
	'' using 5 ti col , \
	'' using 6 ti col , \
