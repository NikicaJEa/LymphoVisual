...
def IGK(folder_name, loc, loc_save, region, patient_id, region_graph, dic, svr, svc, sjr, sjc, srr, src,
    ...
    def IGK_table(data, col_width=10.0, row_height=0.625, font_size=14,
        ...
        fig.savefig("./plots/" + patient_id[0:3] + "_LymphoVisual/" +patient_id + "_IGK_Top10_Merged_seq_table.png")
        return ax

    IGK_table(df, header_columns=0, col_width=5.0)
